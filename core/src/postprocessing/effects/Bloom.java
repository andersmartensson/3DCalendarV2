...
import postprocessing.filters.Blur;
import postprocessing.filters.Combine;
import postprocessing.filters.Threshold;
import postprocessing.utils.PingPongBuffer;
...
public final class Bloom extends PostProcessorEffect {
	...
	public void render (final FrameBuffer src, final FrameBuffer dest) {
		...
		{
			// BLOOM_THRESHOLD / high-pass filter
			// only areas with pixels >= BLOOM_THRESHOLD are blit to smaller fbo
		...
		// mix original scene and blurred BLOOM_THRESHOLD, modulate via
