...
public class Skybox extends GFXObject {
    ...
    public Model createSkyBoxModel() {
        ...
        return mb.createSphere(-scale,-scale,-scale,100,100,m, VertexAttributes.Usage.Position | VertexAttributes.Usage.Normal | VertexAttributes.Usage.TextureCoordinates);
    }
